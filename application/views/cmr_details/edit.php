      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group form-inline">
            ...
            <agdropdown name="cmr_account_name" input_class='required' next_field_id="truckNo" hidden_field_name="cmr_details[account_id]" v-bind:options="accounts" v-model="account_id"> 
            </agdropdown> 
          ...
          <!-- Market Name -->
           <div class="form-group form-inline">
            ...
            <label for="cmr_agency">Market Name</label>
             ...
             <agdropdown next_field_id="society_name" input_class='required' v-on:change="getSocietyDetail" hidden_field_name="cmr_details[cmr_market_id]" v-bind:options="markets" v-model="cmr_market_id" > 
            </agdropdown> 
